// Prüft edition-data.new.js gegen knowledge.js. Aufruf: EXPECTED_DATE=YYYY-MM-DD osascript -l JavaScript validate.js
...
if (errs.length) throw new Error("Validierung fehlgeschlagen (" + errs.length + "): " + errs.slice(0, 12).join(" | "));
"OK " + E.stories.length + " Meldungen, " + n + " Verweise, " + E.date;
